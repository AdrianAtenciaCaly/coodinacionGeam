...
if (isset($_POST['nombredocente']) && isset($_POST['apellidodocente']) && isset($_POST['nombrecompleto']) && isset($_POST['asignaturedocente']) && isset($_POST['statusdocente'])&& isset($_POST['observacionesdocente'])) {
     $db->query("INSERT INTO teacher  VALUES(null,'" . $_POST['nombredocente'] . "','" . $_POST['apellidodocente'] . "','" . $_POST['nombrecompleto'] . "','" . $_POST['asignaturedocente'] . "','" . $_POST['statusdocente'] . "','" . $_POST['observacionesdocente'] . "'
 )")or die($db->error);
