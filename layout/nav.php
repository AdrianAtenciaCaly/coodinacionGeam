        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="#" data-toggle="modal" data-target="#exampleModal"
                    class="nav-link"><?php echo  "Usted es: " . removeJunk(ucfirst($user['name'])); ?></a>
            </li>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="#" class="brand-link">
            <img src="../assets/dist/img/abelmendoza.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                style="opacity: .8">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" data-toggle="modal" data-target="#exampleModal"
                        class="d-block"><?php echo $user['tipo']; ?></a>
                </div>
            </div>
            <!-- SidebarSearch Form -->
              ...
              ?>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="../pages/asistences" class="nav-link">
                                        ...
                                        <p>Asistencias</p>
                                        <span
                                            class="badge badge-info right asitencias"><?php echo $numeroAsistencia['total']; ?></span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="../pages/lessonsEdit" class="nav-link">
                                        ...
                                        <p>Clases</p>
                                        <span
                                            class="badge badge-light right"><?php echo  $numeroClases['total']; ?></span>
                                    </a>
                                </li>
                                <li class="nav-item">
                    ...
                    ?>
                                <li class="nav-item">
                                    ...
                                    <a href="../pages/groupdetails.php?id_group=<?php echo $AllGroup['id_group'] ?>"
                                        class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle"
                                    src="../assets/dist/img/abelmendoza.jpg" alt="User profile picture">
                            </div>
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b>Ultimo inicio de sesión </b> <a
                                        class="float-right"><?php echo  $user['last_login']; ?></a>
                                </li>
                            </ul>
